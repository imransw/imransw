      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            <div class="carousel-background"><img src="assets/img/slide/page-1.jpg" alt=""></div>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="assets/img/slide/page-2.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <!-- Slide 3 -->
          <div class="carousel-item">
            <div class="carousel-background"><img src="assets/img/slide/page-3.jpeg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown mb-0">Himel Minhaj</h2><p> <a href="https://github.com/himel-minhaj" target="_blank">@himelminhaj</a></p>
                <a href="index.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Get Started</a>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row" style="padding-left: 228px;">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.1s">
            <div class="member">
              <img src="assets/img/team/himel.jpg" class="img-fluid" alt="">
              <div class="member-info">
                ...
                <div class="social">
                  ...
                  <a href="https://github.com/himel-minhaj" target="_blank"><i class="fab fa-github"></i></a>
